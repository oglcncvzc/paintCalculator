    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 space-y-6">
            <div className="flex items-center gap-2 border-b border-gray-100 dark:border-gray-800 pb-4">
                ...
                <h3 className="font-semibold">Boyutlar & Özellikler</h3>
            </div>

            <div className="space-y-4">
                <div>
                    <label className="block text-sm font-medium mb-1.5 text-gray-700 dark:text-gray-300">Nesne Şekli</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-xs text-gray-500 mb-1">Yükseklik (cm)</label>
                        <input
                            type="number"
                            name="height"
                    ...
                    <div>
                        <label className="block text-xs text-gray-500 mb-1">Üst Çap (cm)</label>
                        <input
                            type="number"
                            name="topDiameter"
                    ...
                    {dimensions.type === "conical" && (
                        <div className="col-span-2">
                            <label className="block text-xs text-gray-500 mb-1">Alt Çap (cm)</label>
                            <input
                                type="number"
                                name="bottomDiameter"
                ...
                <div className="pt-4 border-t border-gray-100 dark:border-gray-800">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-sm font-medium">Boya Özellikleri</span>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xs text-gray-500 mb-1">Kalınlık (µm)</label>
                            <input
                                type="number"
                                name="thickness"
                        ...
                        <div>
                            <label className="block text-xs text-gray-500 mb-1">Yoğunluk (g/cm³)</label>
                            <input
                                type="number"
                                name="density"
                                step="0.1"
                        ...
                        <div className="col-span-2">
                            <label className="block text-xs text-gray-500 mb-1">Fire Payı (%)</label>
                            <input
                                type="number"
